package com.mynasmah.mykamus.utils.searchView;
...
import com.mynasmah.mykamus.utils.searchView.suggestions.SearchSuggestionsAdapter;
import com.mynasmah.mykamus.utils.searchView.suggestions.model.SearchSuggestion;
import com.mynasmah.mykamus.utils.searchView.util.Util;
import com.mynasmah.mykamus.utils.searchView.util.adapter.GestureDetectorListenerAdapter;
import com.mynasmah.mykamus.utils.searchView.util.adapter.OnItemTouchListenerAdapter;
import com.mynasmah.mykamus.utils.searchView.util.adapter.TextWatcherAdapter;
import com.mynasmah.mykamus.utils.searchView.util.view.MenuView;
import com.mynasmah.mykamus.utils.searchView.util.view.SearchInputView;
...
public class FloatingSearchView extends FrameLayout {
    ...
    private final static int CARD_VIEW_CORNERS_AND_TOP_BOTTOM_SHADOW_HEIGHT = CARD_VIEW_TOP_BOTTOM_SHADOW_HEIGHT + CARD_VIEW_CORNERS_HEIGHT;
    ...
    private void init(AttributeSet attrs) {
        ...
        mSearchInputParent  = (FrameLayout) findViewById(R.id.search_input_parent);
        ...
        mSuggestionListContainer = (CardView) findViewById(R.id.suggestions_list_container);
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            //setQueryTextSize(a.getDimensionPixelSize(R.styleable.FloatingSearchView_floatingSearch_searchInputTextSize, ATTRS_QUERY_TEXT_SIZE_SP_DEFAULT));
            ...
            setCloseSearchOnKeyboardDismiss(a.getBoolean(R.styleable.FloatingSearchView_floatingSearch_close_search_on_keyboard_dismiss, ATTRS_DISMISS_ON_KEYBOARD_DISMISS_DEFAULT));
            ...
            setDismissFocusOnItemSelection(a.getBoolean(R.styleable.FloatingSearchView_floatingSearch_dismissFocusOnItemSelection, ATTRS_DISMISS_FOCUS_ON_ITEM_SELECTION_DEFAULT));
            ...
            mLeftActionMode = a.getInt(R.styleable.FloatingSearchView_floatingSearch_leftActionMode, ATTRS_SEARCH_BAR_LEFT_ACTION_MODE_DEFAULT);
            ...
            setDimBackground(a.getBoolean(R.styleable.FloatingSearchView_floatingSearch_dimBackground, ATTRS_SHOW_DIM_BACKGROUND_DEFAULT));
            setShowMoveUpSuggestion(a.getBoolean(R.styleable.FloatingSearchView_floatingSearch_showMoveSuggestionUp, ATTRS_SHOW_MOVE_UP_SUGGESTION_DEFAULT));
            this.mSuggestionSectionAnimDuration = a.getInt(R.styleable.FloatingSearchView_floatingSearch_suggestionsListAnimDuration, ATTRS_SUGGESTION_ANIM_DURATION_DEFAULT);
            setBackgroundColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_backgroundColor , Util.getColor(getContext(), R.color.background)));
            setLeftActionIconColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_leftActionColor , Util.getColor(getContext(), R.color.left_action_icon)));
            setActionMenuOverflowColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_actionMenuOverflowColor , Util.getColor(getContext(), R.color.overflow_icon_color)));
            setMenuItemIconColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_menuItemIconColor  , Util.getColor(getContext(), R.color.menu_icon_color)));
            setDividerColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_dividerColor , Util.getColor(getContext(), R.color.divider)));
            setClearBtnColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_clearBtnColor , Util.getColor(getContext(), R.color.clear_btn_color)));
            int viewTextColor = a.getColor(R.styleable.FloatingSearchView_floatingSearch_viewTextColor , Util.getColor(getContext(), R.color.dark_gray));
            ...
            //setHintTextColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_hintTextColor , Util.getColor(getContext(), R.color.hint_color)));
            setSuggestionRightIconColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_suggestionRightIconColor , Util.getColor(getContext(), R.color.gray_active_icon)));
    ...
    private void setupQueryBar() {
        ...
        mMenuView.setOnVisibleWidthChanged(this::handleOnVisibleMenuItemsWidthChanged);
     ...
     *              the getSuggestion section background.
     */
     ...
     * and getSuggestion text.
     *
     * @param color the color to be applied to the search and getSuggestion
     *              text.
     */
    ...
    /**
     * Sets whether the search will lose focus when a getSuggestion item is clicked.
     *
    ...
    /**
     * Sets the text color of getSuggestion text.
     *
     * @param color
     */
    ...
    /**
     * Set the tint of the getSuggestion items' right btn (move getSuggestion to
     * query)
     *
     * @param color
     */
    ...
    /**
     * Set the text size of the getSuggestion items.
     *
     * @param sizePx
     */
    ...
    /**
     * Sets the arrow up of getSuggestion items to be enabled and visible or
    ...
    //returns true if the getSuggestion items occupy the full RecyclerView's height, false otherwise
    ...
    //returns the cumulative height that the current getSuggestion items take up or the given max if the
    ...
    /**
     * Set a callback that will be called after each getSuggestion view in the suggestions recycler
     * list is bound. This allows for customized binding for specific items in the list.
     *
     * @param callback A callback to be called after a getSuggestion is bound by the suggestions list's
     *                 adapter.
     */
     ...
     * then clears its getSuggestion items.
     */
    ...
    /**
     * Sets the listener that will be notified when the getSuggestion list's height
     * changes.
     *
     ...
     * search or getSuggestion query from the callback parameter or
...
//            mSuggestionsSection.setVisibility(VISIBLE);
//
//            //restore suggestions list when getSuggestion section's height is fully set
//            mSuggestionSecHeightListener = new OnSuggestionSecHeightSetListener() {
//                @Override
//                public void onSuggestionSecHeightSet() {
...
//    }
     ...
     * changes in the getSuggestion list height that occur when the list is expands/shrinks
    ...
    {
        /**
         * Called when a getSuggestion was clicked indicating
