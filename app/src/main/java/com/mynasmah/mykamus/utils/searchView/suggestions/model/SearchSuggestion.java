package com.mynasmah.mykamus.utils.searchView.suggestions.model;
...
/**
 * An object that represents a single getSuggestion item
...
public interface SearchSuggestion{
     ...
     * for the getSuggestion represented by this object.
     *
     * @return the text for this getSuggestion
     */
    String getBody();
